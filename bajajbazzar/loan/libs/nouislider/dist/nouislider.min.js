! function(t, e) {
    ...
    function O(t, b, o) {
        var l, u, s, i, a, e, c, p = window.navigator.pointerEnabled ? {
                start: "pointerdown",
                move: "pointermove",
                end: "pointerup"
        ...
        function L(m) {
            ...
            return (g = g.slice().sort(function(t, e) {
                ...
                for (h && (r = y.xNumSteps[e]), r || (r = d - f), void 0 === d && (d = f), r = Math.max(r, 1e-7), n = f; n <= d; n = Number((n + r).toFixed(7))) {
                    for (u = (s = (o = y.toStepping(n)) - x) / (m.density || 1), p = s / (c = Math.round(u)), i = 1; i <= c; i += 1) v[(a = x + i * p).toFixed(5)] = [y.fromStepping(a), 0];
        ...
        function F(t) {
            var e, r, n, i, o, s, a = 100 * (t - (e = l, r = b.ort, n = e.getBoundingClientRect(), i = e.ownerDocument, o = i.documentElement, s = mt(i), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (s.x = 0), r ? n.top + s.y - o.clientTop : n.left + s.x - o.clientLeft)) / z();
        ...
        function rt(t, e, r) {
            ...
            for (var o = 1 === h.length ? 0 : 1; o < h.length; ++o) h.forEach(function(t) {
                Z(t, x[t], !0, !0, r)
            });
