function loancalculate() {
    var t = $("#pricipal").text(),
        ...
        l = (t.toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","), o.toFixed(2).toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ",")),
...
function() {
    ...
    if ($(".sliderSecond").length) tns({
        ...
        var e = document.getElementsByClassName("steps-slider")[0],
            i = [document.getElementsByClassName("input-with-keypress-0")[0]];
        noUiSlider.create(e, {
            start: 60,
            animate: !1,
            range: {
            ...
            t.addEventListener("change", (function() {
                e.noUiSlider.setHandle(i, this.value)
            })), t.addEventListener("keydown", (function(t) {
                var s, n = e.noUiSlider.get(),
                    o = Number(n[i]),
                    a = e.noUiSlider.steps()[i];
                switch (t.which) {
                    case 13:
                        e.noUiSlider.setHandle(i, this.value);
                        break;
                    case 38:
                        !1 === (s = a[1]) && (s = 1), null !== s && e.noUiSlider.setHandle(i, o + s);
                        break;
                    case 40:
                        !1 === (s = a[0]) && (s = 1), null !== s && e.noUiSlider.setHandle(i, o - s)
                }
            }))
        }))
    })), jQuery(document).ready((function(t) {
        var e = document.getElementsByClassName("amountSlider")[0],
            i = [document.getElementsByClassName("amountInput")[0]];
        noUiSlider.create(e, {
            start: 3e3,
            animate: !1,
            range: {
        ...
        var e = document.getElementsByClassName("yearSlider")[0],
            i = [document.getElementsByClassName("yearInput")[0]];
        noUiSlider.create(e, {
            start: 2,
            animate: !1,
            range: {
    ...
    function(t) {
        ...
        ! function() {
            ...
            t.position = {
                ...
                e = t.extend({}, e);
                var l, p, f, g, m, _, v = t(e.of),
                    b = t.position.getWithinInfo(e.within),
                    y = t.position.getScrollInfo(b),
                    w = (e.collision || "flip").split(" "),
                    x = {};
                return _ = d(v), v[0].preventDefault && (e.at = "left top"), p = _.width, f = _.height, g = _.offset, m = t.extend({}, g), t.each(["my", "at"], (function() {
                    ...
                    var n, o, a = t(this),
                        ...
                        d = u(this, "marginLeft"),
                        _ = u(this, "marginTop"),
                        k = r + d + u(this, "marginRight") + y.width,
                        C = h + _ + u(this, "marginBottom") + y.height,
                        D = t.extend({}, m),
                ...
                t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], (function(e, i) {
                    ...
                    return this.queue((function() {
                        ...
                        h = h.map((function() {
                            ...
                            return this.end = s(this.el[0]), this.diff = function(e, s) {
                                var n, o, a = {};
                    ...
                    effect: function() {
                        var i = e.apply(this, arguments),
                            ...
                            u = function(e) {
                                ...
                                i.data(l, !0), c.push(s), n && ("show" === s || s === n && "hide" === s) && i.show(), n && "none" === s || t.effects.saveStyle(i), t.isFunction(e) && e()
                            };
                        if (t.fx.off || !s) return h ? this[h](i.duration, r) : this.each((function() {
                            r && r.call(this)
                        }));
                        ...
                        function d(e) {
                            ...
                            i.mode = c.shift(), !1 === t.uiBackCompat || n ? "none" === i.mode ? (o[h](), a()) : s.call(o[0], i, (function() {
                                o.removeData(l), t.effects.cleanUp(o), "hide" === i.mode && o.hide(), a()
                            })) : (o.is(":hidden") ? "hide" === h : "show" === h) ? (o[h](), a()) : s.call(o[0], i, a)
                        }
        ...
        t.extend(t.ui, {
            ...
            _updateDatepicker: function(e) {
                ...
                o.length > 0 && m.apply(o.get(0)), e.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), n > 1 && e.dpDiv.addClass("ui-datepicker-multi-" + n).css("width", 17 * n + "em"), e.dpDiv[(1 !== s[0] || 1 !== s[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), e.dpDiv[(this._get(e, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), e === t.datepicker._curInst && t.datepicker._datepickerShowing && t.datepicker._shouldFocusInput(e) && e.input.trigger("focus"), e.yearshtml && (i = e.yearshtml, setTimeout((function() {
            ...
            _generateHTML: function(t) {
                var e, i, s, n, o, a, r, l, h, c, u, d, p, f, g, m, _, v, b, y, w, x, k, C, D, I, T, P, S, M, H, z, O, A, E, N, W, F, R, L = new Date,
                ...
                for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = V ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - K, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = V ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + K, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : B, a = V ? this.formatDate(a, r, this._getFormatConfig(t)) : a, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", h = j ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (Y ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (Y ? "" : l) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), _ = this._get(t, "showOtherMonths"), v = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", x = 0; x < U[0]; x++) {
                    for (k = "", this.maxRows = 4, C = 0; C < U[1]; C++) {
                        ...
                        for (T += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + I + "'>" + (/all|left/.test(I) && 0 === x ? Y ? o : s : "") + (/all|right/.test(I) && 0 === x ? Y ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || C > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", P = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; w < 7; w++) P += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[S = (w + c) % 7] + "'>" + p[S] + "</span></th>";
                        for (T += P + "</tr></thead><tbody>", M = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, M)), H = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7, z = Math.ceil((H + M) / 7), O = X && this.maxRows > z ? this.maxRows : z, this.maxRows = O, A = this._daylightSavingAdjust(new Date(tt, Z, 1 - H)), E = 0; E < O; E++) {
                            ...
                            T += N + "</tr>"
                        }++Z > 11 && (Z = 0, tt++), k += T += "</tbody></table>" + (X ? "</div>" + (U[0] > 0 && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                    }
                    y += k
                }
    ...
    function(t) {
        ...
        }), t("#pricipal").text(t("#pricipal-slide").slider("value")), t("#totalyear-slide").slider({
            range: "min",
            min: 12,
            max: 360,
            step: 1,
        ...
        }), t("#totalyear").text(t("#totalyear-slide").slider("value")), t("#intrest-slide").slider({
            range: "min",
            min: 6.1,
            max: 16.2,
            step: .01,
        ...
        }), t("#intrest").text(t("#intrest-slide").slider("value")), loancalculate()
    }(jQuery);
var __slice = [].slice,
...
function eligiable() {
    ...
    c > t ? (document.formval3.field13.value = "You are Eligible for this loan", document.formval3.field11.value = "₹ " + t + " at EMI ₹ " + o.toFixed(0), document.formval3.field12.value = "You are Eligible for a maximum loan of ₹ " + c + " at EMI ₹ " + d.toFixed(0)) : (document.formval3.field13.value = "You are not Eligible for this loan", document.formval3.field11.value = "", document.formval3.field12.value = "You are Eligible for a maximum loan of ₹ " + c + " at EMI ₹ " + d.toFixed(0))
}! function(t, e) {
    var i;
    i = function() {
        function e(e, i) {
            ...
            this.input = e, this.defaultOptions = {
                ...
                if (n.dragging) return n.domDrag(e.pageX, e.pageY), t("body").css({
                    cursor: "pointer"
                })
            })).mouseup((function(e) {
                if (n.dragging) return n.dragging = !1, n.dragger.removeClass("dragging"), t("body").css({
                    cursor: "auto"
                })
            })), this.pagePos = 0, "" === this.input.val() ? (this.value = this.getRange().min, this.input.val(this.value)) : this.value = this.nearestValidValue(this.input.val()), this.setSliderPositionFromValue(this.value), s = this.valueToRatio(this.value), this.input.trigger("slider:ready", {
                value: this.value,
                ratio: s,
        ...
        return e.prototype.createDivElement = function(e) {
            ...
            var s, n, o;
            if (null == i && (i = !1), s = t - this.slider.offset().left, s = Math.min(this.slider.outerWidth(), s), s = Math.max(0, s), this.pagePos !== s) return this.pagePos = s, n = s / this.slider.outerWidth(), o = this.ratioToValue(n), this.valueChanged(o, n, "domDrag"), this.settings.snap ? this.setSliderPositionFromValue(o, i) : this.setSliderPosition(s, i)
            ...
            var i, s, n, o;
            return n = this.getRange(), e = Math.min(n.max, e), e = Math.max(n.min, e), this.settings.allowedValues ? (i = null, t.each(this.settings.allowedValues, (function() {
                if (null === i || Math.abs(this - e) < Math.abs(i - e)) return i = this
            })), i) : this.settings.step ? (s = (n.max - n.min) / this.settings.step, o = Math.floor((e - n.min) / this.settings.step), (e - n.min) % this.settings.step > this.settings.step / 2 && o < s && (o += 1), o * this.settings.step + n.min) : e
            ...
            var e, i, s, n, o;
            return this.settings.equalSteps ? (o = this.settings.allowedValues.length, n = Math.round(t * o - .5), e = Math.min(n, this.settings.allowedValues.length - 1), this.settings.allowedValues[e]) : (s = t * ((i = this.getRange()).max - i.min) + i.min, this.nearestValidValue(s))
        }, e.prototype.valueChanged = function(e, i, s) {
            var n;
            if (e.toString() !== this.value.toString()) return this.value = e, n = {
                value: e,
                ratio: i,
        ...
        simpleSlider: function() {
            var e, s, n;
            return n = arguments[0], e = 2 <= arguments.length ? __slice.call(arguments, 1) : [], s = ["setRatio", "setValue"], t(this).each((function() {
                var o, a;
        ...
        return t("[data-slider]").each((function() {
            var e, i, s, n;
            return e = t(this), s = {}, (i = e.data("slider-values")) && (s.allowedValues = function() {
                var t, e, s, o;
                for (o = [], t = 0, e = (s = i.split(",")).length; t < e; t++) n = s[t], o.push(parseFloat(n));
                return o
            }()), e.data("slider-range") && (s.range = e.data("slider-range").split(",")), e.data("slider-step") && (s.step = e.data("slider-step")), s.snap = e.data("slider-snap"), s.equalSteps = e.data("slider-equal-steps"), e.data("slider-theme") && (s.theme = e.data("slider-theme")), e.attr("data-slider-highlight") && (s.highlight = e.data("slider-highlight")), null != e.data("slider-animate") && (s.animate = e.data("slider-animate")), e.simpleSlider(s)
        }))
    }))
}(this.jQuery || this.Zepto), $(document).ready((function() {
        "use strict";
        ...
        function t() {
            ...
            $("#emi").html(h), $("#tbl_emi").html(h), $("#tbl_la").html(c), $("#tbl_nm").html(e), $("#tbl_roi").html(i), $("#tbl_full").html(u), $("#tbl_int").html(d);
            for (var p = "<thead ><tr class='table-head'><th>Payment No.</th><th>Begining Balance</th><th>EMI</th><th>Principal</th><th>Interest</th><th>Ending Balance</th></thead><tbody>", f = parseInt(t), g = 0, m = 0, _ = 0, v = 1; v <= e; v++) g = f * (i / 100 / 12), _ = f - (m = o.toFixed(2) - g.toFixed(2)).toFixed(2), p += "<tr><td>" + v + "</td><td>" + f.toFixed(2) + "</td><td>" + o.toFixed(2) + "</td><td>" + m.toFixed(2) + "</td><td>" + g.toFixed(2) + "</td><td>" + _.toFixed(2) + "</td></tr>", f -= m.toFixed(2);
            p += "</tbody>", $("#loantable").html(p)
        }
        $("#la").bind("slider:changed", (function(e, i) {
            $("#la_value").html(i.value.toFixed(0)), t()
        })), $("#nm").bind("slider:changed", (function(e, i) {
            $("#nm_value").html(i.value.toFixed(0)), t()
        })), $("#roi").bind("slider:changed", (function(e, i) {
            $("#roi_value").html(i.value.toFixed(2)), t()
        })), t()
    })),
    function() {
        var t = $("[data-isotope]");
